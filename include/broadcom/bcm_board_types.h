...
/*
 * This enumerator defines BCM2712 (Raspberry Pi 5 family) board types.
 * These types are defined by the BCM firmware and requested via mbox.
 * This is needed to determine whether current board is bcm2712
 * or other to control the behaviour of the following drivers:
 * macb and pcie_brcmstb.
